...
//UploadFile Upload
func UploadFile(ctx context.Context, userUploadFile graphql.Upload) (*model.FileUpload, error) {
	...
	fileUploadModel, err := FileUploadCreate(ctx, model.NewFileUpload{
		FileID: file.Id,
		UserID: user.ID,
	})
	...
	return fileUploadModel, nil
}

//UploadFileBatch Upload Batch
func UploadFileBatch(ctx context.Context, userUploadFile []*graphql.Upload) ([]*model.FileUpload, error) {
